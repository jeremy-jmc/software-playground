...
def get_response_from_ai(human_input):
    ...
    3/ Don't be overly enthusiastic, don't be cringe, don't be overlay negative, don't be too boring.
...
def get_voice_message(message):
    ...
    response = requests.post(
        'https://api.elevenlabs.io/v1/text-to-speech/?optimize_streaming_latency=0', json=payload, headers=headers)
...
# TODO: speech to text model (whisper) to talk with the machine
# https://youtu.be/5htSGLCroc8?si=CT-68WpCW4G_sjLP